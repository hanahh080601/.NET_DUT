...
namespace MVC
{
    public partial class Form1 : Form
    {
        ...
        private void SetCBBLSH()
        {
            ...
            foreach(LSH i in DAL_QLSV.Instance.getListLSH_DAL())
            {
        ...
        public void ShowDGV()
        {
            ...
            if (id == 0)
            {
                dataGridView1.DataSource = BLL_QLSV.Instance.getListSV_BLL();
            }
            else
            {
                dataGridView1.DataSource = BLL_QLSV.Instance.getSVByNameAndIDLop_BLL("", id);
            }
        }
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.DataSource = BLL_QLSV.Instance.getSVByNameAndIDLop_BLL
